...
class PageDefs {
	...
	static {
		...
		pageDefEntries.add( new PageDefEntry("followedOrganizationList","Followed Organizations List",null))
		pageDefEntries.add( new PageDefEntry("searchOrganizationsResult","Search Organizations Result","com.KPPhaseTwo.app.pages.admins.FollowedOrganizationsListPage"))
		...
		//Add Participant
		pageDefEntries.add( new PageDefEntry("participantList","Participant Result List",null))
	...
	public static getCurrentPageKey(def browser){
		...
		if(!pageName.equalsIgnoreCase("Job Details") && browser.getElement(Browser.XPATH, "//a[text()='Overview']")!= null && browser.isDisplayed("//a[text()='Overview']")){
			pageName = "Overview"
		}
